...
class ConverterMixin:
    ...
    def _row_to_user(self, row: dict) -> Optional[dict]:
    ...
    def _row_to_market(self, row: dict) -> Optional[dict]:
    ...
    def _row_to_bet(self, row: dict) -> Optional[dict]:
    ...
    def _row_to_position(self, row: dict) -> Optional[dict]:
