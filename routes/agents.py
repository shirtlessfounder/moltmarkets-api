"""Agent registration, profiles, reputation, leaderboard, claim, and human registration."""
...
from api import (
    ...
    generate_api_key, generate_verification_code,
...
@router.get("/me", response_model=UserMe, tags=["agents"])
...
@router.get("/me/positions", response_model=PortfolioResponse, tags=["agents"])
...
@router.get("/me/bets", response_model=List[UserBetHistoryItem], tags=["agents"])
...
@router.get("/users/{user_id}", response_model=UserProfile, tags=["agents"])
...
@router.get("/agents/{agent_id}/reputation", response_model=AgentReputationResponse, tags=["agents"])
...
@router.post("/agents/register", response_model=AgentRegisteredWithClaim, tags=["agents"])
...
@router.post("/agents/reset-key", response_model=AgentKeyReset, tags=["agents"])
async def reset_api_key_endpoint(user: dict = Depends(require_auth)):
...
@router.get("/claim/{user_id}", response_model=ClaimPageInfo, tags=["agents"])
...
@router.post("/agents/claim", response_model=ClaimResponse, tags=["agents"])
...
@router.post("/humans/register", response_model=HumanRegistered, tags=["agents"])
...
@router.get("/leaderboard", response_model=List[LeaderboardEntry], tags=["agents"])
